...
contract ConfigLoaderDeploymentSnapshotTest is Test {
    ...
    function _setBaseRuntimeEnv() internal {
        ...
        vm.setEnv("IDLE_RESET_SECONDS", "7200");
        vm.setEnv("HOOK_FEE_PERCENT", "3");
        vm.setEnv("DUST_SWAP_THRESHOLD", "4000000");
        vm.setEnv("ENTER_CASH_MIN_VOLUME", "1500000000");
        vm.setEnv("ENTER_CASH_EMA_RATIO_PERCENT", "202");
        vm.setEnv("HOLD_CASH_PERIODS", "5");
        vm.setEnv("ENTER_EXTREME_MIN_VOLUME", "4500000000");
        vm.setEnv("ENTER_EXTREME_EMA_RATIO_PERCENT", "432");
        vm.setEnv("ENTER_EXTREME_CONFIRM_PERIODS", "3");
        vm.setEnv("HOLD_EXTREME_PERIODS", "5");
        vm.setEnv("EXIT_EXTREME_EMA_RATIO_PERCENT", "128");
        vm.setEnv("EXIT_EXTREME_CONFIRM_PERIODS", "3");
        vm.setEnv("EXIT_CASH_EMA_RATIO_PERCENT", "128");
        vm.setEnv("EXIT_CASH_CONFIRM_PERIODS", "4");
        vm.setEnv("LOW_VOLUME_RESET", "700000000");
        vm.setEnv("LOW_VOLUME_RESET_PERIODS", "4");
    ...
    function _setBaseDeployEnv() internal {
        ...
        vm.setEnv("DEPLOY_IDLE_RESET_SECONDS", "3600");
        vm.setEnv("DEPLOY_HOOK_FEE_PERCENT", "1");
        vm.setEnv("DEPLOY_ENTER_CASH_MIN_VOLUME", "1000000000");
        vm.setEnv("DEPLOY_ENTER_CASH_EMA_RATIO_PERCENT", "185");
        vm.setEnv("DEPLOY_HOLD_CASH_PERIODS", "4");
        vm.setEnv("DEPLOY_ENTER_EXTREME_MIN_VOLUME", "4000000000");
        vm.setEnv("DEPLOY_ENTER_EXTREME_EMA_RATIO_PERCENT", "405");
        vm.setEnv("DEPLOY_ENTER_EXTREME_CONFIRM_PERIODS", "2");
        vm.setEnv("DEPLOY_HOLD_EXTREME_PERIODS", "4");
        vm.setEnv("DEPLOY_EXIT_EXTREME_EMA_RATIO_PERCENT", "125");
        vm.setEnv("DEPLOY_EXIT_EXTREME_CONFIRM_PERIODS", "2");
        vm.setEnv("DEPLOY_EXIT_CASH_EMA_RATIO_PERCENT", "125");
        vm.setEnv("DEPLOY_EXIT_CASH_CONFIRM_PERIODS", "3");
        vm.setEnv("DEPLOY_LOW_VOLUME_RESET", "600000000");
        vm.setEnv("DEPLOY_LOW_VOLUME_RESET_PERIODS", "3");
    }
}
